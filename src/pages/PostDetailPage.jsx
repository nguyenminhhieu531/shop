                        ...
                        <div className="col-span-3 flex gap-3">
                            <ul className="flex flex-col gap-4">
                                <li className="w-[82px] cursor-pointer p-[10px] rounded-md border border-black hover:border-black transition-all">
                                    <img
                                        className="image"
                                        src="./assets/images/img_product_thumb.avif"
                                        alt=""
                                    />
                                </li>
                                <li className="w-[82px] cursor-pointer p-[10px] rounded-md border border-transparent hover:border-black transition-all">
                                    <img
                                        className="image"
                                        src="./assets/images/img_product_thumb2.webp"
                                        alt=""
                                    />
                                </li>
                                <li className="w-[82px] cursor-pointer p-[10px] rounded-md border border-transparent hover:border-black transition-all">
                                    <img
                                        className="image"
                                        src="./assets/images/img_product_thumb4.webp"
                                        alt=""
                                    />
                                </li>
                            </ul>
                            <div className="overflow-hidden">
                                <div className="rounded-xl overflow-hidden">
                                    <img
                                        src="./assets/images/img_product_detail.webp"
                                        className="image"
                                        alt=""
                                    />
                                </div>
                    ...
                    <div className="mt-9 lg:mt-24">
                        ...
                        <div className="mt-9 lg:mt-20">
                            ...
                            <p className="mt-9 text-[#8a8a8a] leading-7">
                                ...
                                textured floral design throughout, shapes this cami top that has wide
                                straps, a high square neckline, and a fitted bodice that ends at a
                                cropped hem with lettuce-edge trim. Get a fresh 'fit for spring with
                                the Free People Love Letter Ivory Floral Jacquard Cropped Cami Top!
                                Stretchy jacquard fabric, with a textured floral design throughout,
                                shapes this cami top that has wide straps, a high square neckline, and
                                a fitted bodice that ends at a cropped hem with lettuce-edge trim.
                            </p>
                        </div>
                    </div>
